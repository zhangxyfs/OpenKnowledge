...
(function () {
  ...
  var EN = {
    ...
    'i.src': 'Source',
    'i.hint': 'Auto-detects your OS · <a href="https://z7dream-gitea.iepose.cn/zhangxyfs/OpenKnowledge/releases/download/v2.12.0/OpenKnowledgeSetup-2.12.0.exe">Windows</a> / <a href="https://z7dream-gitea.iepose.cn/zhangxyfs/OpenKnowledge/releases/download/v2.12.0/openknowledge_2.12.0_amd64.deb">Linux .deb</a> / <a href="https://z7dream-gitea.iepose.cn/zhangxyfs/OpenKnowledge/releases/download/v2.12.0/openknowledge_2.12.0_linux_amd64.tar.gz">Linux .tar.gz</a> · <a href="https://z7dream-gitea.iepose.cn/zhangxyfs/OpenKnowledge/releases" target="_blank" rel="noopener">All releases</a>',
    'i.feat.h': 'Features',
    ...
    'i.f4p': 'Kimi Code, Pi, ZCode, Reasonix, opencode, Claude Code/CodePilot and Codex share the same knowledge base through an extensible adapter architecture.',
